...
?>
    ...
    <div class="pageheader">
      <h2><i class="fa fa-dollar"></i> Add New Advertisement</h2>
    </div>
...
$res = mysql_query("INSERT INTO ads SET title='".$title."', img='".$bgimg."'");
...
$count = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM ads"));

if($count[0]>=4){
	echo "<h1>All Spaces are blocked, Please edit to change</h1>";
}else{
?>	
		...
		<form name="" id="" action="" method="post" enctype="multipart/form-data" >
            <div class="form-group">
              ...
              <div class="col-sm-6"><input name="title" value="" class="form-control" type="text" placeholder="http://"></div>
            </div>
